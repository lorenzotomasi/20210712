...
exports.AttractionResponseJsonSchema = exports.ParkResponseJsonSchema = void 0;
var ParkByIdJsonSchema = {
    type: "object",
    required: ["parkId"],
    properties: {
...
var AttractionTamplateResponse = {
    type: "object",
    properties: {
        id: { type: "number", example: 1 },
...
exports.ParkResponseJsonSchema = {
    descritpion: "",
...
exports.AttractionResponseJsonSchema = {
    descritpion: "",
